export const Colors = {
    ...
    // Type colors from PokedexLoginApp
    types: {
        ...
        aço:    { bg: '#0f0f14', accent: '#90A4AE', glow: 'rgba(144,164,１７４,０.５)' },
...
export function getTypeTheme(types: string[]): { bg: string; accent: string; glow: string } {
